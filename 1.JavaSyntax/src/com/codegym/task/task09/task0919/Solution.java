...
/* 
Dividing by zero
Create a public static void divideByZero method that divides any number by zero, and display the result of division.
Wrap the divideByZero method call in a try-catch block.
Display the exception stack trace using the exception.printStackTrace() method.
...
4. The main method must contain a try-catch block.
