...
Task: The program demonstrates how a HashMap works:
read a set of pairs (a number and string) from the keyboard, put them in a HashMap,
and then displays the contents of the HashMap.
