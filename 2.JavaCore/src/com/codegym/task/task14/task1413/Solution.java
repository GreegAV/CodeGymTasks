...
4. The getName method in classes implementing the CompItem interface should return a simple class name,
 e.g. "Keyboard" for the Keyboard class.
5. The Computer class must be in a separate file and have one private field of each of the following types:
Keyboard, Mouse, and Monitor.
6. The Computer class constructor should have 3 parameters (keyboard, mouse, monitor)
and correctly initialize the corresponding fields of the class.
7. For the Computer class's fields keyboard, mouse, and monitor, you need to create
getters (getKeyboard, getMouse, getMonitor) that return the corresponding fields of the Computer class.
