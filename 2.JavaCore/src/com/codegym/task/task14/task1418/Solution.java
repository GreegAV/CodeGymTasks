...
2. Create static methods initList(List<Number> list), printListValues​​(List<Number> list),
and processCastObjects(List<Number> list) in the Solution class.
3. Find the block of code that fills the list with values ​​and move it to the initList method.
4. Find the block of code that uses a for loop to display the contents of the list,
and move it to the printListValues ​​method.
5. Find the block of code that checks the type of each object of the list and displays messages on the screen,
and move it to the processCastObjects method.
6. Correct 2 bugs in the printListValues ​​method so that the method correctly displays the contents
...
Requirements:
1. The Solution class must implement static methods initList(List<Number> list), printListValues​​(List<Number> list),
and processCastObjects(List<Number> list).
...
4. The processCastObjects method should analyze the list items and display text for Float and Double objects
