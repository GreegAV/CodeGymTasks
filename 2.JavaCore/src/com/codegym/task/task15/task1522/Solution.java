...
5.2. If the value is equal to one of the Planet interface's constants,
create a corresponding object and assign it to Planet thePlanet, otherwise set the Planet thePlanet to null.
