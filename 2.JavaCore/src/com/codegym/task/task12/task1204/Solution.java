...
6. The printObjectType() method must display one of the following messages,
depending on the object passed to it. For example, it should display "Lamp" for a Solution.Lamp object.
