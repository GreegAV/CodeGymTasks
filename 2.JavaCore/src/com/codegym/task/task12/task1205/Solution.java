...
6. The getObjectType() method must return one of the following values:
"Cow", "Whale", "Dog", or "Unknown Animal", depending on the object passed to it.
For instance, it should return "Cow" for Solution.Cow objects.
