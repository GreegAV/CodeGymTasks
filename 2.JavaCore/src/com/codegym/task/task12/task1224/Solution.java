...
public class Solution {
    ...
    public static String getObjectType(Object o) {
        ...
        return o.getClass().getSimpleName().equals("Cat") ? "Cat" :
                o.getClass().getSimpleName().equals("Tiger") ? "Tiger" :
                        o.getClass().getSimpleName().equals("Lion") ? "Lion" :
                                o.getClass().getSimpleName().equals("Bull") ? "Bull" :
                                        o.getClass().getSimpleName().equals("Pig") ? "Pig" :
                                                "Animal";
    }
