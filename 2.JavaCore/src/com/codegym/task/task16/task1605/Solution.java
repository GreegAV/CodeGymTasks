...
6. The Violin class's run method should display how long the instrument was played (in milliseconds).
Use the format given in the example.
...
public class Solution {
    ...
    public static class Violin implements MusicalInstrument {
        ...
        public void run() {
            ...
            System.out.println("Played for " + (finish.getTime() - start.getTime()) + " ms");
        }
    }
}